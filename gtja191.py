...
Available primitives:
    Unary: ABS, SQRT, LOG, SIGN, SQUARE, TANH, NEG, CS_RANK, CS_ZSCORE
    Binary: ADD, SUB, MUL, DIV, MAX2, MIN2
    TS (arr,int): DELTA, DELAY, SUM, MEAN, STD, MIN, MAX, RANK, ROC, ZSCORE, DECAY, POWER
    SMA (arr,int,int): SMA      COV (arr,arr,int): COV
    CORR (arr,arr,int): CORR    IF_POS (arr,arr,arr): IF_POS
...
FACTOR_EXPRS = {
    ...
    'alpha019': None,  # SELF recursive
    'alpha020': "MUL(DIV(SUB(ARG3, DELAY(ARG3, 6)), DELAY(ARG3, 6)), 100.0)",

    # ===== Alpha 021-040 =====
    'alpha021': None,  # REGBETA + SEQUENCE
    ...
    'alpha027': None,  # WMA not available
    'alpha028': "SUB(MUL(3.0, SMA(DIV(SUB(ARG3, TSMIN(ARG2, 9)), SUB(TSMAX(ARG1, 9), TSMIN(ARG2, 9))), 3, 1)), MUL(2.0, SMA(SMA(DIV(SUB(ARG3, TSMIN(ARG2, 9)), SUB(TSMAX(ARG1, 9), TSMAX(ARG2, 9))), 3, 1), 3, 1)))",
    'alpha029': "MUL(DIV(SUB(ARG3, DELAY(ARG3, 6)), DELAY(ARG3, 6)), ARG5)",
    'alpha030': None,  # WMA + REGRESI + MKT/SMB/HML
    ...
    'alpha046': "DIV(ADD(ADD(MEAN(ARG3, 3), MEAN(ARG3, 6)), ADD(MEAN(ARG3, 12), MEAN(ARG3, 24))), MUL(4.0, ARG3))",
    'alpha047': "SMA(DIV(SUB(TSMAX(ARG1, 6), ARG3), SUB(TSMAX(ARG1, 6), TSMIN(ARG2, 6))), 9, 1)",
    'alpha048': None,  # complex with SIGN cascades
    'alpha049': None,  # DTM/DBM based
    'alpha050': None,  # DTM/DBM based
    'alpha051': None,  # DTM/DBM based
    'alpha052': None,  # complex ternary + special
    'alpha053': None,  # COUNT with comparison
    'alpha054': "NEG(CS_RANK(ADD(ADD(STD(ABS(SUB(ARG3, ARG0)), 10), SUB(ARG3, ARG0)), CORR(ARG3, ARG0, 10))))",
    'alpha055': None,  # extremely complex ternary
    'alpha056': None,  # comparison chaining
    'alpha057': "SMA(DIV(SUB(ARG3, TSMIN(ARG2, 9)), SUB(TSMAX(ARG1, 9), TSMIN(ARG2, 9))), 3, 1)",
    'alpha058': None,  # COUNT with comparison
    ...
    'alpha110': None,  # ternary + nested MAX
    'alpha111': None,  # SMA nesting with VOL
    'alpha112': None,  # complex SUM with comparisons
    'alpha113': None,  # complex nested RANK+CORR
    'alpha114': None,  # complex division cascade
    'alpha115': None,  # complex RANK^RANK
    'alpha116': None,  # REGBETA + SEQUENCE
    ...
    'alpha122': None,  # multi-layer SMA-LOG nesting
    'alpha123': None,  # comparison chain
    ...
    'alpha137': None,  # same as alpha055
    ...
    'alpha143': None,  # SELF recursive
    'alpha144': None,  # SUMIF + COUNT
    'alpha145': "MUL(DIV(SUB(MEAN(ARG5, 9), MEAN(ARG5, 26)), MEAN(ARG5, 12)), 100.0)",
    'alpha146': None,  # complex MEAN/SMA nesting
    'alpha147': None,  # REGBETA + SEQUENCE
    'alpha148': None,  # comparison chain
    'alpha149': None,  # REGBETA + FILTER + benchmark
    'alpha150': "MUL(DIV(ADD(ADD(ARG3, ARG1), ARG2), 3), ARG5)",
    'alpha151': "SMA(SUB(ARG3, DELAY(ARG3, 20)), 20, 1)",
    'alpha152': None,  # complex SMA/MEAN/DELAY nesting
    'alpha153': "DIV(ADD(ADD(MEAN(ARG3, 3), MEAN(ARG3, 6)), ADD(MEAN(ARG3, 12), MEAN(ARG3, 24))), 4.0)",
    'alpha154': None,  # comparison
    'alpha155': None,  # SMA multi-layer
    ...
    'alpha157': None,  # PROD + MIN + TSRANK
    'alpha158': None,  # SMA + complex
    'alpha159': None,  # has HGIH typo, complex nested
    'alpha160': "SMA(IF_POS(SUB(DELAY(ARG3, 1), ARG3), STD(ARG3, 20), 0.0), 20, 1)",

    # ===== Alpha 161-180 =====
    'alpha161': None,  # MEAN of MAX of ABS
    'alpha162': None,  # SMA(RSI-style)
    'alpha163': "CS_RANK(MUL(MUL(MUL(NEG(ARG4), MEAN(ARG5, 20)), ARG6), SUB(ARG1, ARG3)))",
    'alpha164': None,  # SMA + complex ternary
    'alpha165': None,  # SUMAC + MIN/MAX
    ...
    'alpha169': None,  # SMA/MEAN/DELAY multi-layer
    'alpha170': None,  # complex RANK nesting
    'alpha171': None,  # complex POWER division
    'alpha172': None,  # HD/LD/TR based
    'alpha173': None,  # SMA + LOG multi-layer
    'alpha174': "SMA(IF_POS(SUB(ARG3, DELAY(ARG3, 1)), STD(ARG3, 20), 0.0), 20, 1)",
    'alpha175': None,  # MEAN of MAX of ABS (ts)
    'alpha176': None,  # CORR of RANK
    'alpha177': None,  # HIGHDAY
    ...
    # ===== Alpha 181-191 =====
    'alpha181': None,  # benchmark + complex SUM
    'alpha182': None,  # benchmark + COUNT/OR
    'alpha183': None,  # SUMAC + MIN/MAX/STD
    ...
    'alpha186': None,  # HD/LD/TR based
    'alpha187': None,  # ternary + MAX nesting
    'alpha188': None,  # SMA of HIGH-LOW
    'alpha189': "MEAN(ABS(SUB(ARG3, MEAN(ARG3, 6))), 6)",
    'alpha190': None,  # COUNT + SUMIF + LOG + benchmark
